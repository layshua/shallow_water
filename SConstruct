...
print '******************************************'
print '** Welcome to the build script of ADV1D **'
print '******************************************'
print 'ADV1D Copyright (C) 2013'
print ''
print '  Technische Universitaet Muenchen'
print '  Department of Informatics'
print '  Chair of Scientific Computing'
print ''
print 'ADV1D comes with ABSOLUTELY NO WARRANTY.'
print 'ADV1D is free software, and you are welcome to redistribute it'
