...
\begin{minted}[linenos,fontsize=\scriptsize,bgcolor=bg]
{julia}
...
\begin{minted}[linenos,fontsize=\scriptsize,firstnumber=9,bgcolor=bg]
{julia}
...
\begin{minted}[linenos,fontsize=\scriptsize,firstnumber=26,bgcolor=bg]
{julia}
const G = 9.81f0
...
\begin{minted}[linenos,fontsize=\scriptsize,firstnumber=40,bgcolor=bg]
{julia}
...
\end{minted}
\begin{minted}[linenos,fontsize=\scriptsize,firstnumber=67,bgcolor=bg]
{julia}
# Kernels: (qs, Fl, Fr, ncells, dx, dt) -> nothing 
...
\end{minted}
\newpage
\begin{minted}[breaklines,breakanywhere,linenos,firstnumber=85,fontsize=\scriptsize]
{julia}
...
qs,t,ts = run_experiment(50, 1000, make_cfl_dt(w), 
